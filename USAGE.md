...
|---|---|---|---|
| `sk-ant-*` API key | `ANTHROPIC_API_KEY` | `x-api-key: INSERT API KEY HEAR` | [console.anthropic.com](https://console.anthropic.com) |
...
export ANTHROPIC_AUTH_TOKEN="INSERT API KEY HEAR"
...
export OPENAI_API_KEY="INSERT API KEY HEAR"
...
```bash
export DASHSCOPE_API_KEY="INSERT API KEY HEAR"
